/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79b25a19bdde60eeb0824e0de08ee1c7)
// Runtime types generated with workerd@1.20260811.1 2026-08-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	COOKIE_ENCRYPTION_KEY: string;
	ACCESS_PASSPHRASE: string;
	CRAWL4AI_ENGINE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COOKIE_ENCRYPTION_KEY" | "ACCESS_PASSPHRASE" | "CRAWL4AI_ENGINE_URL" | "CRAWL4AI_API_TOKEN" | "SEARXNG_URL">> {}
}
